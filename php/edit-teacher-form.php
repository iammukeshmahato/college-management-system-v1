            ...
            <div class="form-container">
                ...
                <form action="update-teacher.php" method="post">
                    ...
                    <div class="form-item">
                        ...
                        <input type="text" name="address" value="<?php if (!isset($_SESSION['inputTeacherAdd'])) echo $data['t_address'];
                                                                    echo $_SESSION['inputTeacherAdd']; ?>" class="input" id="fullname" required placeholder="Enter your full address" autocomplete="off">
                    </div>

                    <div class="form-item">
                        <p class="title">Gender</p>
                        <input type="radio" class="radio" name="gender" value="Male" required <?php if (!(isset($_SESSION['inputTeacherGender'])) && $data['t_gender'] == "Male") echo "checked";
                                                                                                if ($_SESSION['inputTeacherGender'] == "Male") {
                                                                                                    echo "checked";
                                                                                                    unset($_SESSION['inputTeacherGender']);
                                                                                                } ?>><span>Male</span>
                        <input type="radio" class="radio" name="gender" value="Female" required <?php if (!(isset($_SESSION['inputTeacherGender'])) && $data['t_gender'] == "Female") echo "checked";
                                                                                                if ($_SESSION['inputTeacherGender'] == "Female") {
                                                                                                    echo "checked";
                                                                                                    unset($_SESSION['inputTeacherGender']);
                                                                                                } ?>><span>Female</span>
                        <input type="radio" class="radio" name="gender" value="Other" required <?php if (!(isset($_SESSION['inputTeacherGender'])) && $data['t_gender'] == "Other") echo "checked";
                                                                                                if ($_SESSION['inputTeacherGender'] == "Other") {
                                                                                                    echo "checked";
                                                                                                    unset($_SESSION['inputTeacherGender']);
                                                                                                } ?>><span>Other</span>
                    </div>
                    ...
                    <div class="form-item">
                        <div class="contact two-column">
                            <div class="email col-1">
                                ...
                                <input type="email" class="input" value="<?php if (!isset($_SESSION['inputTeacherEmail'])) echo $data['t_email'];
                                                                            echo $_SESSION['inputTeacherEmail']; ?>" id="fullname" name="email" required placeholder="example@gmail.com" autocomplete="off">
                            ...
                            <div class="phone col-2">
                                ...
                                <input type="tel" class="input" value="<?php if (!isset($_SESSION['inputTeacherPhone'])) echo $data['t_contact'];
                                                                        echo $_SESSION['inputTeacherPhone']; ?>" id="phone" name="phone" placeholder="Must be 10 digits" required autocomplete="off">
